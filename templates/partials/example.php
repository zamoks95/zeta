<div class="Example bg-indigo-700 fixed flex inset-0 items-center justify-center">
	<div class="Example__inner max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
		...
		<p class="mt-4 text-lg leading-6 text-indigo-200">
			This is a just a very minimaliasdasdasdstic theme boiler that gets you started with
		...
		<a href="https://philkurth.com.au/" target="_blank" rel="noopener noreferrer" class="mt-8 w-full inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-indigo-50 sm:w-auto">
		...
		<a href="https://twitter.com/mishterkurth" target="_blank" rel="noopener noreferrer" class="mt-8 w-full inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-indigo-50 sm:w-auto">
			<!-- SVG: Twitter bird -->
